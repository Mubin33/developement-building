      ...
      <div className="bg-[#111] text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Construction Shop</h1>
            ...
            <button
              ...
              className="flex items-center gap-2 bg-primary text-white px-6 py-3 font-bold uppercase tracking-wider rounded-sm hover:bg-secondary transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="relative h-[220px] overflow-hidden bg-white">
                  ...
                  {!product.inStock && (
                    <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                      <span className="bg-gray-800 text-white px-4 py-2 font-bold uppercase">
                        Out of Stock
                      </span>
                    </div>
                  )}
                ...
                {/* Content */}
                <div className="p-5">
                  <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 h-12">{product.name}</h3>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-secondary/10 text-secondary px-3 py-2.5 text-sm font-bold uppercase rounded-sm hover:bg-secondary hover:text-white transition-colors"
                    >
                      Details
                    </button>
                    <button
                      ...
                      className="flex-1 bg-primary text-white px-3 py-2.5 text-sm font-bold uppercase rounded-sm hover:bg-secondary transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-1"
                    >
                      <Plus size={16} />
                      Add
                    </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-sm shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              {/* Content */}
              <div className="p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-3">{selectedProduct.name}</h2>

                <p className="text-gray-600 text-sm outfit mb-4">{selectedProduct.description}</p>
                ...
                {/* Stock Status */}
                <div
                  className={`inline-flex items-center gap-1 px-3 py-1 rounded-sm text-sm font-semibold mb-4 ${
                ...
                <>
                      ...
                      <div key={item.id} className="flex gap-4 bg-[#f4f7f9] p-4 rounded-sm">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            ...
                            <span className="w-8 text-center font-semibold outfit">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() => updateQuantity(item.id, 1)}
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-xl font-bold text-secondary outfit">
                        ৳{cartTotal.toLocaleString("en-BD")}
                      </span>
                    </div>
